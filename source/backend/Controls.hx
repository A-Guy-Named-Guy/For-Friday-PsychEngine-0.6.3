...
class Controls
{
	...
	private function get_GLEFT_P()
		return justPressed('guard_left');

	private function get_DDOWN_P()
		return justPressed('guard_down');

	private function get_GUP_P()
		return justPressed('guard_up');

	private function get_GRIGHT_P()
		return justPressed('guard_right');

	private function get_ATTACK_P()
		return justPressed('attack');

	private function get_SPECIAL_P()
		return justPressed('special');
	...
	private function get_GLEFT()
		return pressed('guard_left');

	private function get_DDOWN()
		return pressed('guard_down');

	private function get_GUP()
		return pressed('guard_up');

	private function get_GRIGHT()
		return pressed('guard_right');

	private function get_ATTACK()
		return pressed('attack');

	private function get_SPECIAL()
		return pressed('special');
	...
	private function get_GLEFT_R()
		return justReleased('guard_left');

	private function get_DDOWN_R()
		return justReleased('guard_down');

	private function get_GUP_R()
		return justReleased('guard_up');

	private function get_GRIGHT_R()
		return justReleased('guard_right');

	private function get_ATTACK_R()
		return justReleased('attack');

	private function get_SPECIAL_R()
		return justReleased('special');
