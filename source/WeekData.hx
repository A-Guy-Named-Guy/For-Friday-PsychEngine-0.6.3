						...
						if (weekFile != null
							&& (isStoryMode == null
								|| (isStoryMode
									...
									&& (!CharacterSelectState.shouldOpenCharacterSelect()
										|| (weekFile.characterSpecific == ''
											|| weekFile.characterSpecific == null
											|| weekFile.characterSpecific == CharacterSelectState.currentSelectedStoryCharacter)))
	...
	private static function addWeek(weekToCheck:String, path:String, directory:String, i:Int, originalLength:Int)
	{
		if (!weeksLoaded.exists(weekToCheck))
		{
			...
			if (week != null)
			{
				...
				// Combat change
				// add:
				// weekFile.characterSpecific != '' ? weekFile.characterSpecific == CharacterSelectState.currentSelectedStoryCharacter : weekFile.characterSpecific == ''
				// into PlayState.isStoryMode && !weekFile.hideStoryMode)
				// (the part in this whole check that excludes weeks with hideStoryMode active)
