...
class Conductor
{
	...
	public static function mapBPMChanges(song:SwagSong)
	{
		...
		// SwagSong notes code
		//
		// This records all relevant bpm changes and puts the information into an array
		//
		// For the purpose of chart-chunks, can be done on a chart-to-chart basis,
		// But these changes are tied to song time, so it cannot be left to leaving all charting info in notes
	...
	static function getSectionBeats(song:SwagSong, section:Int)
	{
		...
		// SwagSong notes code
		//
		// This calculates the current beat of the current chart
		// The beat number can vary from chart to chart, so a name should be attached to a chart to narrow to the correct one
