...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function update(elapsed:Float)
	{
		...
		// Combat change
		// Something to assist debugging achievements
		#if debug
		if (FlxG.keys.justPressed.SLASH)
		{
			if (Achievements.achievementsMap.get(Achievements.achievementsStuff[curSelected][2]))
			{
				Achievements.achievementsMap.set(Achievements.achievementsStuff[curSelected][2], false);
